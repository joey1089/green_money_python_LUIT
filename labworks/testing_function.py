...
def split_name(name):
    # names = name.split() # used for names with one space between two names
    # first_name = names[0]
    # last_name = names[-1]
    first_name, last_name = name.split(maxsplit=1) # used for multi space, after first name then rest is treated as second name
    return {
